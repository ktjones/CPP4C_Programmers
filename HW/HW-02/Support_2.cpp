...
ShortestPathAlgo::ShortestPathAlgo() : Dj_Shortest_Path(), Dj_Shortest_Path_Size(0)
{
...
void ShortestPathAlgo::ShortestPathAlgo_Path(int s, int d, const Graph & g)
{
	...
	priority_queue<pair<int,double>, vector<pair<int,double> >, ShortestPathAlgo> Dj_PQ;	// Dj_Priority Queue with a helper class to provide Greater Than Comparison operator
...
double ShortestPathAlgo::ShortesPathAlgo_Path_Size(int s, int d, const Graph & g)
{

	ShortestPathAlgo_Path(s, d, g);
...
//********************************
//
//   ShortestPathAlgo Future Methods
//
//********************************
...
//********************************
//
//   ShortestPathAlgo Overloaded Operators
//
//********************************

int ShortestPathAlgo::operator()(const pair<int,double> & p1, const pair<int,double> & p2)
{
